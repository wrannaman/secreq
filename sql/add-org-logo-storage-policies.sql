...
-- Allow UPDATE for organization logos (owners/editors only)
CREATE POLICY "org owners can update org logos"
ON storage.objects
FOR UPDATE
TO authenticated
USING (
...
-- Allow DELETE for organization logos (owners/editors only)
CREATE POLICY "org owners can delete org logos"
ON storage.objects
FOR DELETE
TO authenticated
USING (
